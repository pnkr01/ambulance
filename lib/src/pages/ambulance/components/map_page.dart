...
import 'package:ambulance/src/utils/errordialog.dart';
...
class _MapPageState extends State<MapPage> {
  ...
  GoogleMapPolyline googleMapPolyline =
      GoogleMapPolyline(apiKey: "AIzaSyAq1fzuhGMRNZ7S2LtBYjgsJPgwtBkF9UM");
  ...
  Future<List<NearByAmbulanceResult>> getNearby(
    ...
    var response = await https.get(
      Uri.parse(
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=30000&type=ambulance&keyword=ambulance&key=AIzaSyAq1fzuhGMRNZ7S2LtBYjgsJPgwtBkF9UM",
      ),
    );
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                  elevation: 0, backgroundColor: foregroundColor),
              onPressed: () async {
                showDialog(
                  context: context,
                  builder: ((context) {
